...
export MYSQL_ROOT_PASSWORD=${MYSQL_ENV_MYSQL_ROOT_PASSWORD:-PASSWORD}
export MYSQL_HOST=${MYSQL_HOST:-mysql}
export MYSQL_PORT=${MYSQL_PORT:-3306}
export JACKET_DB_USER=${JACKET_DB_USER:-jacket}
export JACKET_DB_PASS=${JACKET_DB_PASS:-PASSWORD}
...
JACKET_PASSWORD=${JACKET_PASSWORD:-PASSWORD}
JACKET_HOST=${JACKET_HOST:-$HOSTNAME}
INSTANCES_PATH=${INSTANCES_PATH:-/root/mnt/sdb/instances}

NOVA_USER_NAME=${NOVA_USER_NAME:-nova}
NOVA_PASSWORD=${NOVA_PASSWORD:-PASSWORD}
METADATA_SHARED_SECRET=${METADATA_SHARED_SECRET:-PASSWORD}

CINDER_USER_NAME=${CINDER_USER_NAME:-cinder}
CINDER_PASSWORD=${CINDER_PASSWORD:-PASSWORD}

NEUTRON_USER_NAME=${NEUTRON_USER_NAME:-nova}
NEUTRON_PASSWORD=${NEUTRON_PASSWORD:-PASSWORD}
